...
var selAllDrum = document.querySelectorAll(".drum");

for(var i = 0; i < selAllDrum.length; i++){
  selAllDrum[i].addEventListener("click", function(){
...
document.addEventListener("keypress", function(event){
  ...
  document.querySelector(cl).classList.toggle("pressed");
